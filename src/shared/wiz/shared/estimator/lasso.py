...
from wiz.shared.estimator import FeatureArray, DoubleArray, RegressionCoeficients
...
class LassoModel(Regressor):
    ...
    def feature_importance(self, features: FeatureArray) -> RegressionCoeficients:
